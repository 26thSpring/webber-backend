...
<body>
					...
					<form action="/admin/notice/noticeUpdate" method="POST"
						...
						<table>
							<tr>
								...
								<td width="150" height="30"><input type="text"
									name="writer" size="15" id="txtWriter"
									value="${content.nickname}" readonly="readonly" /></td>
							</tr>
							<tr>
								<td width="100" height="30" align="center">제목</td>
								<td width="400" height="30"><input type="text" name="title"
									size="50" id="txtTitle" value="${content.title}" /></td>
							</tr>
							<tr>
								<td width="100" height="30" align="center">내용</td>
								<td width="400">
									<textarea name="content" style="width: 400px; height: 150px" id="txtCont">${content.content}</textarea>
								</td>
							</tr>
							...
							<tr>
								<td colspan="2">
									...
									<input type="button" value="삭제" data-target="#delNotice" data-toggle="modal"/>&nbsp;&nbsp;
	...
	<!-- 삭제 확인 창 -->
	<div class="modal fade" id="delNotice" tabindex="-1" role="dialog">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button"
						onclick="location.href='/admin/notice/noticeDel?board_id=${content.board_id}'"
