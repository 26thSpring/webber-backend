...
public class BoardRestController {
	...
	public List<BoardVo> getList(@RequestParam HashMap<String, Object> map) {
		System.out.println("54564654"+map);
	...
	public BoardVo getBoardVo(@PathVariable("board_id") String board_id, @RequestParam HashMap<String, Object> map) {
		...
		/*
		 * System.out.println(replyList.toString()); System.out.println(map);
	...
	/*
	 * POST /api/community {nickname, title, contents} 게시판에 자료를 추가한다. PUT
	 * /api/community/:board_id {title, contents} 게시판에 자료를 수정한다. DELETE
	 * /api/community/:board_id 구분자 값의 게시자료를 삭제한다.
	 */
	...
	public ResultMsgVo updateBoard(@PathVariable("board_id") String board_id, 
	...
	public ResultMsgVo deleteBoard(@PathVariable("board_id") String board_id, @RequestBody String token,
			@RequestParam HashMap<String, Object> map) {
		map.put("board_id", board_id);
